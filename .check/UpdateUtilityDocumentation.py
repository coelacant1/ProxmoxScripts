...
def generate_markdown():
    ...
    md_lines.append("### NetworkHelper.sh")
    ...
    md_lines.append('source "${UTILITYPATH}/ProxmoxAPI.sh"')
    ...
    md_lines.append("bash Utilities/_TestProxmoxAPI.sh")
    md_lines.append("")
